import type { BoardPreview, BoardTaskPreview, DropdownOption, ModalItem, SidebarBoard } from './BoardView.types'
...
export const fallbackBoards: SidebarBoard[] = [
...
export function buildFallbackBoardPreviews(boards: SidebarBoard[]): BoardPreview[] {
...
export function buildSidebarBoards(boards: BoardPreview[]): SidebarBoard[] {
  return boards.map((board) => ({
    id: board.id,
    name: board.name,
  }))
...
export const fallbackBoardPreviews = buildFallbackBoardPreviews(fallbackBoards)
